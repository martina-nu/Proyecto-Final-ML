...
def intro():
    ...
    nombre1 = '<p style="font-family:Calabria; color:Black; font-size: 40px;"> 👩‍💼 Romina Gonella</p>'
    st.markdown(nombre1, unsafe_allow_html=True)
    st.markdown("### 👩‍💼 Martina Nuñez")
    st.markdown("### 👨‍💼 Eduardo Coyto ")
...
demo_name = st.sidebar.selectbox("Choose the type of analysis", page_names_to_funcs.keys())
